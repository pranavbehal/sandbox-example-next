    ...
    <nav role="navigation" className="main-nav">
      ...
      >
        Walruses
          ...
          <Link
        href="/sharks"
        className={`nav-item ${pathname === "/sharks" ? "active" : ""}`}
        aria-current={pathname === "/sharks" ? "page" : undefined}
      >
        Sharks
      </Link>
          <Link
        href="/apes"
        className={`nav-item ${pathname === "/apes" ? "active" : ""}`}
        aria-current={pathname === "/apes" ? "page" : undefined}
      >
        Apes
      </Link>
          <Link
        href="/lemurs"
        className={`nav-item ${pathname === "/lemurs" ? "active" : ""}`}
        aria-current={pathname === "/lemurs" ? "page" : undefined}
      >
        Lemurs
      </Link>
    </nav>
